...
Ext.define('SailPoint.LCM.AvailableIdentitiesGrid', {
  ...
  clickSingleIdentity : function(gridView, record) {
      this.removeListener('itemclick', this.clickSingleIdentity); // remove this listener if we've already initiated a single identity request so we don't submit another one
