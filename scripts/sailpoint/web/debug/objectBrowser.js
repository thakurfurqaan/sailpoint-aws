...
SailPoint.editObject = function(id, className, name, useName) {
...
SailPoint.initObjectBrowser = function(classList){
    ...
    actionsCombo.on('select', function(combo, recordsArray, index){
        ...
        if (action === 'new'){
            ...
            SailPoint.editObject("", className, undefined, true);
        }
            ...
            items: [
                {
                    ...
                    handler : function(){
                        SailPoint.editObject('SystemConfiguration', 'Configuration', undefined, true);
                    }
                },
                {
                    text: 'UI Configuration',
                    handler : function(){
                        SailPoint.editObject('UIConfig', 'UIConfig', undefined, true);
                    }
                },
                {
                    text: 'Identity Configuration',
                    handler : function(){
                        SailPoint.editObject('Identity', 'ObjectConfig', undefined, true);
                    }
                },
                {
                    text: 'Link Configuration',
                    handler : function(){
                        SailPoint.editObject('Link', 'ObjectConfig', undefined, true);
                    }
                },
                
                {
                    ...
                    handler : function(){
                        SailPoint.editObject('ElectronicSignature', 'Configuration', undefined, true);
                    }
                },
                
                {
                    ...
                    handler: function() {
                        SailPoint.editObject('SAML', 'Configuration', undefined, true);
                    }
                },
