...
SailPoint.web.workitem.renderApprovalItemCalendar = function(workitemId, approvalItemId, startDate, endDate) {
    ...
    var activationDateWindow =  createActivationWin(approvalItemId);
    
    activationDateWindow.setType('role');
...
function createActivationWin(approvalItemId) {
    
    return Ext.create('SailPoint.AssignmentDateWindow',{
