 ...
 * like formName:uniqueJSFComponentIterationId:inputId, hence things like Ext.getDom('formName:inputId')
...
Ext.define('SailPoint.define.applications.FieldQuerier', {
    ...
    getFieldValue: function(field, sectionDiv, cssSelector) {
        var val, vField, vCssSelector,
            vSectionDiv = (sectionDiv) ? sectionDiv : '#tabSettings_';
