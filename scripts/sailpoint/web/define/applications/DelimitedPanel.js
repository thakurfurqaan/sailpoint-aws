...
Ext.define('SailPoint.define.applications.DelimitedPanel', {
    ...
    toggleTransport: function() {
        var showHideArrayMap = [{
            show: [],
            hide: ['#transportCredentialssftp_','#transportHost_','#transportPort_','#transportUser_','#transportUserPW_']
            },
            {
                show: ['#transportHost_','#transportUser_','#transportUserPW_'],
                hide: ['#transportPort_','#transportCredentialssftp_']
            },
            {
                show: ['#transportHost_','#transportUser_','#transportUserPW_'],
                hide: ['#transportPort_','#transportCredentialssftp_']
