        ...
        archiveWindow = new Ext.Window({
            ...
            bbar: [{
                ...
                handler: function() {
                    ...
                    if (Ext.getDom('viewerForm:roleToEdit')) {
                        // We're in the role viewer
                        Ext.getDom('viewerForm:roleToEdit').value = '';
                        Ext.getDom('viewerForm:archiveToEdit').value = archiveId;
                        Ext.getDom('viewerForm:editArchive').click();
                    } else {
                        // Assume that we're in the role editor
                        SailPoint.modeler.RoleEditor.prepareForRollback(archiveId);
                        Ext.getDom('rollbackForm:applyRollback').click();
                    }
                }
            },{
                id: 'closeArchiveBtn',
