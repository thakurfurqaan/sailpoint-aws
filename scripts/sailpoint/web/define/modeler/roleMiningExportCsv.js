    ...
    initComponent: function() {
		...
		exportCsvDialog.okButton = new Ext.Button( {
			...
			handler: function() {
				...
				var exportIdentityAttributesField = Ext.getDom( 'exportForm:exportIdentityAttributesField' );
			    ...
			    /* Export results */
                Ext.getDom( 'exportForm:exportTaskId' ).value = resultToExport;
				var exportButton = Ext.getDom( 'exportForm:scheduleExportTaskBtn' );
				exportButton.click();
	  		}
		} );
...
SailPoint.roles.ProcessProgress = function() {
	var progressField = Ext.getDom( 'exportForm:exportProgressField' );
...
Ext.define('ExportTaskProgressMonitor', {
	...
	checkTaskProgress: function() {
		Ext.getDom( 'exportForm:exportProgressBtn' ).click();
	},
