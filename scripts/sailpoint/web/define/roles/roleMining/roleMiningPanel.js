...
Ext.define('SailPoint.Role.ITRoleMiningPanel', {
    ...
    updateIpopAppsAndDescription: function(ipop) {
    	if (ipop) {
            Ext.Ajax.request({
                ...
                success: function (result, options) {
                	...
                	this.updateIpopDescription(currentIpopInfo);
                	// This is dead code right now.  See IIQETN-8618
                	// this.addApplicationsForIpop(currentIpopInfo);
                },
                scope: this
            });
    	} else {
        	this.updateIpopDescription(null);
        	// This is dead code right now.  See IIQETN-8618
            // this.addApplicationsForIpop(null);    		
    	}
    },
    
    updateIpopDescription: function(currentIpopInfo) {
    ...
    // This method is dead right now.  See IIQETN-8618
    addApplicationsForIpop: function(currentIpopInfo) {
        var miningAppNameMultiSuggest = Ext.getCmp('itRoleMiningAppNameMultiSuggestCmp');
