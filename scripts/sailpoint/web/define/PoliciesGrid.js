    ...
    statics : {
        ...
        deletePrompt : function() {
            ...
            var title = '#{msgs.policies_grid_delete_prompt_title}',
                body = '#{msgs.policies_grid_delete_prompt_text}',
                encodedName = Ext.String.htmlEncode(name);
            Ext.MessageBox.confirm(Ext.String.format(title, encodedName), Ext.String.format(body, encodedName), SailPoint.Define.Grid.Policy.deletePolicy);
        },
