...
Ext.define('SailPoint.WorkflowVariableAdvancedPanel', {
    ...
    addVariable : function (variable, deferInsert) {
      ...
      var ctr = {
          ...
          collapsible: true,
          cls: 'variable',
          title: '<div class="varName">'+Ext.String.htmlEncode(vName)+'</div><div class="varDescription">'+Ext.String.htmlEncode(vDescription)+'</div>',
          layout: {
              type: 'table',
              columns: 1
          },
                ...
                if (map.containsKey(varName)) {
                    ...
                    if (!Ext.isEmpty(mapValue)) {
                        ...
                        if(mapValue instanceof Array) {
                            mapSource = SailPoint.Utils.arrayToCSV(mapValue);
                        }
                        else {
