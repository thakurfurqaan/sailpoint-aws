...
Ext.define('SailPoint.WorkflowStepPanel', {    
    ...
    autoLayout : function() {
        // IIQSAW-1249 : need to translate "items" to "sections" and "buttons" in the form
        // same as in save()
        this.transformWorkflowStepForms();
    ...
    editForm : function(stepId) {
        ...
        this.formWindow = new SailPoint.form.editor.WorkflowFormEditorWindow({
            //IIQETN-6171 :- Removing localization for beanType, this should be handled as a constant.
            beanType: 'workflow',
            panel: this
        });
    ...
    /**
     * Transform all forms in workflow steps from "items" to "sections" and "buttons" array.
     * Used in autoLayout and save.
     */
    transformWorkflowStepForms : function () {
    ...
    validate : function () {
        ...
        if (invalid) {
            this.parent.errorText = Ext.String.format("#{msgs.workflow_error_duplicate_step_name}", Ext.String.htmlEncode(dupeName));
            return false;
        } 
