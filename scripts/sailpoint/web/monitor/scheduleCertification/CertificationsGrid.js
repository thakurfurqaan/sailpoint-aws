...
Ext.define('SailPoint.monitor.certifications.CertificationsGrid', {
    ...
    initComponent : function() {
        ...
        this.addListener('itemclick', function(gridView, record, HTMLitem, index, e, eOpts){
            ...
            if (Ext.getDom('editForm:certificationGroupId')){
                Ext.getDom('editForm:certificationGroupId').value = id;
                Ext.getDom('editForm:viewCertificationGroup').click();
            }
            else if (Ext.get('dashboardForm:certificationGroupId')) {
                Ext.getDom('dashboardForm:certificationGroupId').value = id;
                Ext.getDom('dashboardForm:viewCertificationGroup').click();
            }          
        });
    ...
    createCertificationFromTemplate: function(menuItem, e) {
        Ext.getDom('editForm:templateCertId').value = menuItem.certId;
