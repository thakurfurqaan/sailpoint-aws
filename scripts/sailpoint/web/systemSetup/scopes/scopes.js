Ext.onReady(function(){
    ...
    var enableScopes = (Ext.getDom('editForm:enableScopes').value === 'true');
    // shorthand
    var Tree = Ext.tree;
    ...
    if (enableScopes){
        tree.on('itemmove',
            function(node, oldParent, newParent, index, opts) {
                Ext.getDom('editForm:movedScopeId').value = node.getId();
                Ext.getDom('editForm:oldParentScopeId').value = oldParent.getId();
                Ext.getDom('editForm:newParentScopeId').value = newParent.getId();
                Ext.getDom('editForm:moveScopeBtn').click();
            });
    ...
    function newScope() {
        Ext.getDom('editForm:parentId').value = this.nodeId;
        Ext.getDom('editForm:newScopeBtn').click();
    }

    function editScope() {
        Ext.getDom('editForm:selectedScopeId').value = this.nodeId;
        Ext.getDom('editForm:editScopeBtn').click();
    }

    function deleteScope() {
        Ext.getDom('editForm:selectedScopeId').value = this.nodeId;
        Ext.getDom('editForm:deleteScopeBtn').click();
    }
