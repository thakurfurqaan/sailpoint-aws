...
SailPoint.SystemSetup.Login = {
    ...
    initializePage: function(activeTab, isLcmEnabled) {
        ...
        tabItems.push({title: '#{msgs.mfa_config}', id: 'mfaConfigPanel', contentEl: 'mfaConfigPanelContent'});
        ...
        var tabPanel = new Ext.TabPanel({
            ...
            afterLayout: function() {
                var mfaConfigContainer = Ext.getCmp('mfaConfigContainer');
                if(mfaConfigContainer) { 
                    mfaConfigContainer.doLayout();
                }       
            }
    ...
    persist: function() {
        var identityAttExt = Ext.getCmp(SailPoint.SystemSetup.Login.phoneAttributeId), 
            ...
            mfaConfigContainer = Ext.getCmp('mfaConfigContainer');
        
        if (phoneAttHidden && identityAttExt) {
            phoneAttHidden.value = identityAttExt.getValue();
        }

        if (Ext.isDefined(mfaConfigContainer)) {
            mfaConfigContainer.prepareToPersist();
        }
    },
