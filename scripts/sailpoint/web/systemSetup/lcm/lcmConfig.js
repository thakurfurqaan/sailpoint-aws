    ...
    Ext.applyIf(config, {
        ...
        items: [
            ...
            }),
            {
                ...
                title: '#{lcm_config_identity_provisioning_policies}',
                contentEl: 'identityPolicyContents',
                autoScroll: true
            }
        ],
        activeTab: 'additionalOptionsPanel'
    });
...
SailPoint.systemSetup.lcm.initTabPanel = function(addtAcctApps, acctOnlyApps, disableAutoRefAcctApps) {
    var tabPanel = SailPoint.systemSetup.lcm.getTabPanel({region: 'center'}, addtAcctApps, acctOnlyApps, disableAutoRefAcctApps);
      tabPanel.on('afterrender', function(component, eOpts) {
    ...
    var viewport = SailPoint.getViewport({
        ...
        title: '#{msgs.lifecycle_manager}',
        minWidth: 600,
        wrappingForm: 'editForm'
    }); 
