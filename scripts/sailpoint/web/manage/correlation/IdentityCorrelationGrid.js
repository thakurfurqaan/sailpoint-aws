                                ...
                                items : [
                                   {
                                        ...
                                        items : [{
                                                ...
                                                store : SailPoint.Store.createStore({
                                                    ...
                                                    url : SailPoint.getRelativeUrl('/manage/correlation/identityTypes.json')
                                                }),
                                                valueField: 'name',
                                    ...
                                    },
                                    {
                                        ...
                                        items : [{
                                                ...
                                                xtype:'textfield',
                                                fieldLabel: '#{msgs.identity_correlation_identity_grid_col_software_version}',
                                                name: 'q_softwareVersion',
                                                anchor:'95%'
                                            },{
                                                xtype:'identitySuggest',
                                                fieldLabel: '#{msgs.identity_correlation_identity_grid_col_administrator}',
                                                name: 'q_administrator',
                                                anchor:'95%'
                                            }
                                        ]
                                    }
