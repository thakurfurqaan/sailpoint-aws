...
Ext.define('SailPoint.Store', {
    ...
    statics : {
        ...
        getStoreConfig : function(config) {
            ...
            // Bug #24562 - Default to simple sort mode to avoid double quotes in the request url.
            // We're not using the multi-sort capability now and likely won't in the future anyway.
            tmpProxy.simpleSortMode = true;

            // However, leave the option to disable simple sort if we need it.
