...
Ext.define('sailpoint.notification.Reminder', {
    ...
    , initDom : function () {
        ...
        this.startHowManyDaysText = Ext.getDom("reminderStartHowManyDaysText");
        this.startHowManyDaysErrorLabel = Ext.get("reminderStartHowManyDaysErrorLabel");
        this.beforeRadio = Ext.getDom("reminderBeforeRadio");
        this.afterRadio = Ext.getDom("reminderAfterRadio");
        this.onceEveryText = Ext.getDom("reminderOnceEveryText");
        this.frequencyOnceRadio = Ext.getDom("reminderFrequencyOnceRadio");
        this.frequencyOnceEveryRadio = Ext.getDom("reminderFrequencyOnceEveryRadio");
        this.frequencyOnceRadio.onclick = this.onFrequencyRadioClick.bind(this);
        this.frequencyErrorLabel = Ext.get("reminderFrequencyErrorLabel");
    }
