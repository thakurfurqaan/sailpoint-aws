...
var ImageRadio = ('undefined' != typeof ImageRadio) ? ImageRadio : {
    ...
    attachEventsToDiv: function(div) {
        div = Ext.get(div);
        if(div.dom.className.match("imageRadio") && !ImageRadio._isDisabled(div)) {
            ...
            div.un("mousedown", ImageRadio._onmousedown);
            div.un("mouseup", ImageRadio._onmouseup);
            div.un("mouseover", ImageRadio._onmouseover);
            div.un("mouseout", ImageRadio._onmouseout);

            div.on("mousedown", ImageRadio._onmousedown, false);
            div.on("mouseup", ImageRadio._onmouseup, false);
            div.on("mouseover", ImageRadio._onmouseover, false);
            div.on("mouseout", ImageRadio._onmouseout, false);
        }
    },
    ...
    disable: function(div) {
        ...
        if (div && !ImageRadio._isDisabled(div)) {
            ...
            if (ImageRadio._isSelected(div.dom.className)) {
    ...
    unselectRadio: function(radio) {
        var div = Ext.get(radio.parentNode);
    ...
    getRadioValue: function(radio) {
        ...
        var radios = ImageRadio._getRadios(ImageRadio.getRadio(radio));
        var _radio = radios.map(function(elt) {
            return elt.checked;
        })[0];
    ...
    _getRadios: function(radio) {
        ...
        return Ext.Array.clean(allRadios.map(function(elt) {
            return (radio.name === elt.name) ? elt : null;
        }));
    },
    ...
    _onmouseover: function(event) {
        var div = Ext.getDom(event.target.id);
