        ...
        Ext.Ajax.request({
			...
			success: function(response){
				...
				if (!respObj.success && respObj.errorMsg == ''){
					...
					Ext.getDom('editForm').innerHTML = '#{msgs.no_identity}';
					var buttons = this.getDockedItems('toolbar[dock="bottom"]')[0].items;
            ...
            */
			...
			params: {id:Ext.getDom('editForm:id').value, linkId:this.linkId, newIdentity:newIdentity, existingIdentity:existingIdentity}
        });
