...
Ext.define('SailPoint.form.MultiSelect', {
    ...
    constructor: function(config) {
        ...
        // Default tpl expression encodes the value to avoid XSS throught combo results, consumers should set
        // comboTemplate if they want HTML.  I dont anticipate anyone expecting a combo result to contain renderable HTML.
        var tplExpression = config.comboTemplate || '{'+config.displayField+':htmlEncode}';
