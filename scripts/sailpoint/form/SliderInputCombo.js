            ...
            listeners: {
                change: {
                    fn: function(slider, newVal) {
                        var input = Ext.getCmp(config.numberField);
                        if (input) {
                            input.setValue(Math.round(1 * newVal) / 1);
                        }
                    }
                }
            }
...
Ext.define('SailPoint.SliderInputCombo', {
    ...
    initComponent: function() {
        ...
        this.numberfield.on('change', this.synchInputs, this);
        this.slider.on('change', this.synchInputs, this);
