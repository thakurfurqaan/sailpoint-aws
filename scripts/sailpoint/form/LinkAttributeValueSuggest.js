...
Ext.define('SailPoint.LinkAttributeValueSuggest', {
    ...
    /**
     * The ID of the certificationItem
     */
    ...
    initComponent:function() {
        ...
        Ext.applyIf(this, {
            store:  SailPoint.Store.createStore({
                url: SailPoint.getRelativeUrl('/include/linkAttributeValueSuggest.json?application=' + this.application + '&attrName=' + this.attributeName + '&isPermission=' + this.isPermission + '&certificationItem=' + this.certificationItem),
                root: 'values',
