...
Ext.define('SailPoint.form.DateRange', {
    ...
    constructor: function(config) {
        ...
        /**
         * Just update them both when either one changes.  It was getting confusing.
         */
        function changeListener() {
            me.endDate.setMinValue(me.startDate.getValue());
            me.startDate.setMaxValue(me.endDate.getValue());
        }
        ...
        if (val) {
            ...
            if (val.end) {
                startConfig.maxValue = val.end;
            }
        }
        startConfig.listeners = {
