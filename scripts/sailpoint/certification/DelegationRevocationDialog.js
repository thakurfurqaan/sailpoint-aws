...
Ext.define('SailPoint.certification.DelegationRevocationDialog', {
    ...
    reset : function(){
        if (Ext.fly("delegationRevocationMsg")){
            Ext.getDom("delegationRevocationMsg").innerHTML = "#{msgs.cert_dialog_loading}";
        }
    },
        ...
        if (messageIncludesDelegatee){
            ...
            Ext.Ajax.request({
                ...
                success: function(response){
                    ...
                    Ext.getDom("delegationRevocationMsg").innerHTML = messageHtml;
            ...
            Ext.getDom("delegationRevocationMsg").innerHTML = msgTpl;
            this.callParent(arguments);
        }
    },
