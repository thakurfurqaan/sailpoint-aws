...
SailPoint.certification.BaseCertificationGrid.renderAccountAttribute = function(value, metadata, record, rowIdx, colIdx, store) {
    ...
    try{
        ...
        if (entitlement){
            html = SailPoint.certification.BaseCertificationGrid.createEntitlementHtml(entitlement.name, entitlement.description, null, false, record.internalId)
        }
    ...
    try {
        ...
        for(var i=0;i<entitlements.length;i++){
            ...
            html += SailPoint.certification.BaseCertificationGrid.createEntitlementValuesString(entitlement,
                    value.application, value.isNew, record.internalId);
        }
    } catch(err){
    ...
    try{
        ...
        if (value.permissions && value.permissions.length > 0){
            for(var p=0;p<value.permissions.length;p++){
                ...
                html += SailPoint.certification.BaseCertificationGrid.createEntitlementHtml(permission.name, permission.description, null, value.isNew, record.internalId);
                html += "</div>";
                html += "<div style='margin-left:15px'>";
                html += SailPoint.certification.BaseCertificationGrid.createEntitlementValuesString(permission, value.application, value.isNew, record.internalId);
                html += "</div>";
            }
        }
        ...
        if (value.attributes && value.attributes.length > 0){
            for(var a=0;a<value.attributes.length;a++){
                ...
                html += SailPoint.certification.BaseCertificationGrid.createEntitlementHtml(attribute.name, attribute.description, null, value.isNew, record.internalId);
                html += "</div>";
                html += "<div style='margin-left:15px'>";
                html += SailPoint.certification.BaseCertificationGrid.createEntitlementValuesString(attribute, value.application, value.isNew, record.internalId);
                html += "</div>";
            }
        }
 ...
 */
SailPoint.certification.BaseCertificationGrid.createEntitlementValuesString = function(entitlement, application, isNew, certificationItemId) {
    var html = "";
    for(var v=0;v<entitlement.values.length;v++){
        ...
        html += SailPoint.certification.BaseCertificationGrid.createEntitlementHtml(entitlementValue.displayValue,
                entitlementValue.description, groupInfo, isNew, certificationItemId);
 ...
 * @param groupInfo
 */
SailPoint.certification.BaseCertificationGrid.createEntitlementHtml = function(name, description, groupInfo, isNew, certificationItemId) {
    ...
    html += SailPoint.certification.BaseCertificationGrid.createEntitlementSpan(name, groupInfo, certificationItemId);
    if (descIcon)
    ...
    html += SailPoint.certification.BaseCertificationGrid.createEntitlementSpan(description ? description : name, groupInfo, certificationItemId);
 ...
 */
SailPoint.certification.BaseCertificationGrid.createEntitlementSpan = function(text, groupInfo, certificationItemId){
