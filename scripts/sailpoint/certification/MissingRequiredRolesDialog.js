Ext.define('SailPoint.certification.MissingRequiredRolesDialog', {
    ...
    init : function(){
        ...
        this.setTitle(titleTpl.apply([Ext.String.htmlEncode(this.certificationItem.getDescription())]));
        ...
        if (this.decision.requiresDelegationReview == true){
            ...
            this.delegationReviewMessage = Ext.String.format(msg, Ext.String.htmlEncode(delegationOwnerName));
        }
