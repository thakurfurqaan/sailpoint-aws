...
SailPoint.showarcsightDataExportDDLDialog = function(){
    var win;
    win = new Ext.Window({
    ...
    win.on("show", function(){
        Ext.Ajax.request({
            scope:this,
            url: SailPoint.getRelativeUrl('/monitor/tasks/arcsightDataExportSchema.json'),
            ...
            params: {database:Ext.getDom('editForm:database').value}
        });
    }, win);
