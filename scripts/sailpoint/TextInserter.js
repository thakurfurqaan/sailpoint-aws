 ...
 */
SailPoint.TextInserter = function(textFieldElt, selectFieldElt) {
    this.textField = Ext.getDom(textFieldElt);
    this.selectField = Ext.getDom(selectFieldElt);

    Ext.get(this.selectField).on("change", this.insertElementFromSelect.bind(this), false);
};
